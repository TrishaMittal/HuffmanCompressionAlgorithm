...
from classhuffman import Huffman
...
class TestHuffman(unittest.TestCase):
    ...
    def test_freqtable(self, filesize):
        ...
        built_freq_table = huffman.build_char_table(self.RANDOM_FILENAME)
    ...
    def test_huffstack(self, filesize, arity_exp):
        ...
        freq_table = huffman.build_char_table(self.RANDOM_FILENAME)
        hufftree_hash = {}
        for char in freq_table:
            hufftree_hash[char] = [freq_table[char], 0, True]
        code_stack, root_symbol = huffman.build_huffman_tree(freq_table, arity_exp)
        last_freq = 0
